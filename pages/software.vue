<template>
  ...
  threshold: .5
                  ...
                  <v-card height="100%">
                    <v-img :src="require('@/assets/techno/' + beta.image)" :alt="'Geode-solutions ' + beta.title"
                      cover />
  ...
  threshold: .5
                  ...
                  <v-card height="100%">
                    <v-img :src="require('@/assets/techno/coming-soon.jpg')" :alt="'Geode-solutions ' + next.title"
                      cover />
                    <v-card-title primary-title class="justify-center text-h4 px-5 ma-4">
                      {{ next.title }}
                    </v-card-title>
