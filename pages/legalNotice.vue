    ...
    <v-row>
      <v-col>
        ...
        <p style="text-align: justify">
          ...
          Adresse :
          <strong>Technopole Hélioparc, 2 Avenue Pierre Angot 64053 Pau cedex
            9</strong><br>
          ...
          <strong>contact@geode-solutions.com</strong><br>
        ...
        <p style="text-align: justify">
          ...
          modifications ayant été apportées depuis leur mise en ligne.<br>
        </p>
        ...
        <p style="text-align: justify">
          ...
          préalable à l'email :
          <a href="mailto:contact@geode-solutions.com"><strong>contact@geode-solutions.com</strong></a>.<br>
          ...
          L.335-2 et suivants du Code de Propriété Intellectuelle.<br>
        </p>
        ...
        <p style="text-align: justify">
          ...
          contenus illicites.<br>
          <br>
          L’utilisateur est informé que lors de ses visites sur le site
          <a
            href="https://geode-solutions.com"
            target="_blank"
          >geode-solutions.com</a>, un ou des cookies sont susceptible de s’installer automatiquement
          ...
          son ordinateur pour refuser l’installation des cookies.<br>
        </p>

        <p style="text-align: justify">
          <strong>5. Protection des biens et des personnes - gestion des données
        ...
        <p style="text-align: justify">
          ...
          <a
            href="https://geode-solutions.com"
            target="_blank"
          >geode-solutions.com</a>, le proprietaire du site ne collecte des informations personnelles
          relatives à l'utilisateur que pour le besoin de certains services
          proposés par le site
          <a
            href="https://geode-solutions.com"
            target="_blank"
          >geode-solutions.com</a>. L'utilisateur fournit ces informations en toute connaissance de
