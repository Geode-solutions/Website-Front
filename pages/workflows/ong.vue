...
async function sendStepOne () {
    ...
    await api_fetch('geode/workflows/ong/step1', { method: 'POST', body: params },
        {
...
async function sendStepTwo () {
    ...
    await api_fetch('geode/workflows/ong/step2', { method: 'POST', body: params },
        {
            'request_error_function': () => {
                toggle_loading()
            },
...
async function sendStepThree () {
    ...
    await api_fetch('geode/workflows/ong/step3', { method: 'POST', body: params },
        {
            'request_error_function': () => {
                toggle_loading()
            },
