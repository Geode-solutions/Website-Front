                            ...
                            <v-expansion-panel-text>
                                <v-sheet :max-height="260" class="overflow-auto" color="transparent">
                                    <div v-for="n in surfaceIDS.length - 1">
                                        <WorkflowsSimplexRemeshSurfaceMetric :num="n" :id="surfaceIDS[n]">
                                        </WorkflowsSimplexRemeshSurfaceMetric>
                                    </div>
                                </v-sheet>
                            </v-expansion-panel-text>
                        </v-expansion-panel>
                            ...
                            <v-expansion-panel-text>
                                <v-sheet :max-height="260" class="overflow-auto" color="transparent">
                                    <div v-for="n in blockIDS.length - 1">
                                        <WorkflowsSimplexRemeshBlockMetric :num="n" :id="blockIDS[n]">
                                        </WorkflowsSimplexRemeshBlockMetric>
                                    </div>
                                </v-sheet>
                            </v-expansion-panel-text>
                        </v-expansion-panel>
...
async function getBRepIDs () {
    ...
    await api_fetch('geode/workflows/simplex/get_brep_info', { method: 'POST' },
        {
