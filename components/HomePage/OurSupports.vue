<template>
  <v-container fluid style="background-color: white" class="pb-0">
...
<script setup>
  ...
  import logo_region from "~/assets/img/logos/logo_region.png"
  import logo_geoliens from "~/assets/img/logos/logo_geoliens.png"
