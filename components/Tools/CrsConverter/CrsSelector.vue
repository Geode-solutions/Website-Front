<template>
  <v-data-table :v-model:items-per-page="25" :headers="headers" :items="desserts" item-value="name" class="elevation-1"
    density='compact' fixed-header></v-data-table>
</template>
